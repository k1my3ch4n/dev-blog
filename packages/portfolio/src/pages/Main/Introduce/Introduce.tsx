        ...
        rhs={
          <>
            ...
            <List>
              ...
              있습니다. 대표적으로 CRA 환경에서 빌드 속도 지연 문제를 VITE 마이그레이션을 통해
              개선해 빌드 시간을 약 <Highlight>72%</Highlight> 단축했습니다.
            </List>
            <List>
              Github Actions, AWS, Notion을 활용한{' '}
              <Highlight>배포 및 버저닝 CI/CD 자동화</Highlight>를 구축하여 생산성을 높였습니다.
              또한, Yarn Workspaces를 활용한 <Highlight>Monorepo 구성</Highlight> 및{' '}
              <Highlight>Zero Install</Highlight>
              적용을 통해 개발 환경을 최적화했습니다.
            </List>
            <List>
              다양한 직군과의 원활한 소통을 위해 노력하며 협업 효율성을 높이는 데 기여했습니다. 서버
              팀과의 API 개발 협의를 위해 <Highlight>MSW</Highlight>를 도입하고, 디자인 팀과의
              일관된 UI 개발을 위해 <Highlight>Storybook</Highlight>을 적극적으로 활용했습니다.
            </List>
            <List>
              안정적인 서비스 운영을 위해 jest, React Testing Library, MSW를 활용한 테스트 코드를
              작성하고, 테스트 커버리지를 <Highlight>20%에서 87%</Highlight>까지 향상시켜 코드
              품질을 높였습니다.
            </List>
          </>
        }
