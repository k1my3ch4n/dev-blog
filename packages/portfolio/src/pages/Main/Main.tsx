      ...
      <div className={styles.content}>
        ...
        <SplitGrid
          ...
          rhs={
            <>
              <Text>
                2년차 웹 프론트엔드 개발자로 자율주행 로봇 스타트업에서 유저 및 관리자가 로봇을
                제어할 수 있도록 관제하는 웹 프로덕트를 개발 및 서비스하면서 커리어를 시작했습니다.
              </Text>
              <List>
                개발 환경 개선에 관심이 많습니다. 배포 및 버저닝을 자동화하고, 빌드 시간 단축 등
                자원 소모를 줄인 경험을 가지고 있고 , 이로써 개발에 집중할 수 있는 환경을 만드는데
                관심이 많습니다 .
              </List>
              <List>
