import { Bold, Text, Title, Header, Highlight } from '@monorepo/core/components';
    ...
    <>
      ...
      <List>
        ...
        <List spot="m">
          멀티오더피킹 , 토탈피킹 기능 개발
          <List spot="s">
            <Bold>멀티오더피킹</Bold> : 여러 송장을 모아서 한 번에 피킹 작업을 실행
          </List>
          <List spot="s">
        ...
        <List spot="m">
          ...
          <List spot="s">
            <Bold>커버로지스 , 한익스프레스 등 5개 이상의 화주사에 신규 사업 유치 및 납품</Bold>
          </List>
        </List>
      </List>
      ...
      <List>
        ...
        <NumberList>
          ...
          <>
            ...
            <List spot="m">
              <Highlight>github action</Highlight>을 통해서 배포 및 버저닝 자동화 진행
            </List>
          </>
          {/* 2 */}
          <>
            ...
            <List spot="m">
              기존 사용하던 <Highlight>CRA</Highlight> 의 여러 문제점으로 인해서 불편함을 인지
              <List spot="s">
            ...
            <List spot="m">
              따라서 <Highlight>CRA</Highlight> 의 대안으로 떠오른 <Highlight>VITE</Highlight> 및{' '}
              <Highlight>monorepo</Highlight> 적용
              ...
              <List spot="s">
                <Highlight>pnp</Highlight> 모드 적용으로 <Highlight>zero-install</Highlight> 적용
              </List>
            </List>
          </>
          {/* 3 */}
          <>
            ...
            <List spot="m">
              <Highlight>graphql</Highlight> 사용 중 , 서버 개발이 늦어지는 경우 클라이언트에서
              기다려야 하는 경우 발생
            </List>
            <List spot="m">
            ...
            <List spot="m">
              ...
              <List spot="s">
                서버 개발이 늦어지는 경우 , <Bold>미리 API 명세서</Bold>를 보고 작업 가능
              </List>
              <List spot="s">
                해당 작업 후 서버 측에 <Bold>API 명세에 대한 피드백</Bold> 전달 가능 ({' '}
                <Bold>프론트엔드 주도 인터페이스 개발</Bold> )
              </List>
